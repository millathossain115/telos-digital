    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#141312] flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <main className="flex-1 pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-7 sm:p-9 rounded-3xl bg-white/70 border border-black/[0.08]/80 backdrop-blur-md">
            {COLLABORATION_RULES.map((rule) => (
              <div key={rule.title} className="space-y-2 border-l border-black/[0.08]/80 pl-5">
          ...
          <div className="space-y-16">
            {PHASES.map((phase, idx) => {
              ...
              return (
                <section
                  key={phase.step}
                  className="p-8 sm:p-12 rounded-3xl bg-neutral-900/25 border border-black/[0.08]/80 hover:border-neutral-700/80 transition-all duration-300 backdrop-blur-sm relative overflow-hidden shadow-2xl"
                >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-6">
                      ...
                      <div className="space-y-3 pt-2">
                        <div className="text-xs font-mono text-neutral-600 uppercase tracking-wider">
                    ...
                    <div className="lg:col-span-5 space-y-5">
                      <div className="rounded-2xl bg-[#FAF8F5] border border-black/[0.08] p-6 space-y-4 shadow-xl">
                        ...
                        <div className="space-y-3">
                          {phase.clientTouchpoints.map((tp) => (
                            <div
                              key={tp}
                              className="p-3 rounded-xl bg-white/85 border border-black/[0.08]/60 text-xs text-neutral-300 leading-relaxed flex items-start gap-2.5"
                            >
                        ...
                        <div className="pt-2 text-[11px] font-mono text-neutral-500 border-t border-black/[0.08]/60">
