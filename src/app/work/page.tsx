    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans selection:bg-amber-900 selection:text-white">
      ...
      <main className="flex-1 pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-24 left-1/2 -tranneutral-x-1/2 w-[750px] h-[400px] bg-white/5 blur-[150px] rounded-full" />
          <div className="absolute top-1/2 right-10 w-[500px] h-[500px] bg-amber-600/10 blur-[140px] rounded-full" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                  ...
                  <div className="lg:col-span-7 space-y-6">
                    <div className="flex flex-wrap items-center gap-3">
                      <span className="text-xs font-mono px-3 py-1 rounded-full bg-neutral-800 border border-neutral-700 text-neutral-300 font-medium">
                        {project.client}
                      </span>
                    ...
                    <div>
                      <h2 className="text-2xl sm:text-3xl font-semibold text-white tracking-tight group-hover:text-amber-100 transition-colors">
                        {project.title}
                      </h2>
