        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="p-7 sm:p-8 rounded-3xl bg-slate-900/40 border border-slate-800/80 backdrop-blur-xl shadow-xl space-y-6">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="group flex items-start gap-4 p-3.5 rounded-2xl bg-slate-950/60 border border-slate-800/60 hover:border-indigo-500/50 transition-colors"
                  >
                    ...
                    <div>
                      <div className="text-xs font-mono text-slate-500">Direct Inquiries</div>
                  ...
                  <div className="flex items-start gap-4 p-3.5 rounded-2xl bg-slate-950/60 border border-slate-800/60">
                    ...
                    <div>
                      <div className="text-xs font-mono text-slate-500">Headquarters & Reach</div>
                  ...
                  <div className="flex items-start gap-4 p-3.5 rounded-2xl bg-slate-950/60 border border-slate-800/60">
                    ...
                    <div>
                      <div className="text-xs font-mono text-slate-500">Working Cadence</div>
                      <div className="text-sm font-medium text-slate-300">
              ...
              <div className="p-7 sm:p-8 rounded-3xl bg-gradient-to-br from-indigo-950/40 via-slate-900/50 to-slate-900/30 border border-indigo-900/40 shadow-xl backdrop-blur-xl space-y-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center w-full py-3 px-5 rounded-xl bg-slate-100 hover:bg-white text-slate-950 font-semibold text-sm shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 gap-2 font-sans"
                >
              ...
              {/* Trust Badge */}
              <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-slate-900/30 border border-slate-800/60 text-xs font-mono text-slate-400">
            ...
            <div className="lg:col-span-7">
              <div className="p-8 sm:p-12 rounded-3xl bg-slate-900/40 border border-slate-800/90 shadow-2xl backdrop-blur-xl relative">
                ...
                {isSubmitted ? (
                  <div className="py-12 flex flex-col items-center text-center space-y-4 animate-in fade-in zoom-in duration-300">
                    ...
                    <p className="text-slate-400 max-w-md text-sm leading-relaxed">
                      Thank you, <span className="text-slate-200 font-medium">{form.name}</span>. Our engineering team will review your specification and reply within 24 hours with architectural feedback.
                    </p>
                    <button
                      onClick={() => {
                      ...
                      className="mt-6 px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-xs font-mono text-slate-300 transition-colors"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-7">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-slate-950/80 border border-slate-800 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"
                        />
                      </div>
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-mono text-slate-300 flex items-center justify-between">
                        ...
                        <span className="text-slate-500 text-[11px]">Goals & Timeline</span>
                      </label>
                      <textarea
                        rows={4}
                        value={form.details}
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-slate-950/80 border border-slate-800 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors resize-none leading-relaxed"
                      />
                    </div>
