...
import comparisonDataJson from "@/data/comparisonData.json";
import type { ComparisonData, ComparisonCardData } from "@/types/comparison";

const comparisonData: ComparisonData = comparisonDataJson as ComparisonData;
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* 3-Column Visual Comparison Cards (Data-driven from JSON) */}
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          {comparisonData.comparisonCards.map((card: ComparisonCardData) => {
            if (card.isHighlight) {
              return (
                <motion.div
                  key={card.id}
