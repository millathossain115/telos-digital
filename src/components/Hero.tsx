  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden bg-[#FAF8F5] text-[#141312] pt-32">
      ...
      <motion.div
        ...
        <div className="relative w-full rounded-t-2xl sm:rounded-t-3xl border-t border-x border-b-0 border-black/[0.08] border-t-amber-500/40 bg-white/80 shadow-[0_20px_50px_rgba(20,19,18,0.04)] backdrop-blur-xl overflow-hidden [mask-image:linear-gradient(to_bottom,black_55%,transparent_98%)]">
          <img
